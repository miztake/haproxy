...
struct proxy {
	...
	int clitcpkaintvl;                      /* The time (in seconds) between individual keepalive probes. (client side) */
	int clitcpkaprobes;                     /* The maximum number of keepalive probes TCP should send before dropping the connection. (client side) */
	int clitcpkatime;                       /* The time (in seconds) the connection needs to remain idle before TCP starts sending keepalive probes. (client side) */
	int srvtcpkaintvl;                      /* The time (in seconds) between individual keepalive probes. (server side) */
	int srvtcpkaprobes;                     /* The maximum number of keepalive probes TCP should send before dropping the connection. (server side) */
	int srvtcpkatime;                       /* The time (in seconds) the connection needs to remain idle before TCP starts sending keepalive probes. (server side) */
