...
struct proxy {
	...
	int clitcpka_probes;                    /* The maximum number of keepalive probes TCP should send before dropping the connection. (client side) */
	int clitcpka_time;                      /* The time (in seconds) the connection needs to remain idle before TCP starts sending keepalive probes. (client side) */
	int srvtcpka_intvl;                     /* The time (in seconds) between individual keepalive probes. (server side) */
	int srvtcpka_probes;                    /* The maximum number of keepalive probes TCP should send before dropping the connection. (server side) */
	int srvtcpka_time;                      /* The time (in seconds) the connection needs to remain idle before TCP starts sending keepalive probes. (server side) */
